...
<body>
 ...
 <header class="header">
            ...
            <div class="search-form">
                <input type="search" id="search-box" class="form-control" placeholder="Szukaj tutaj...">
                <label for="search-box" class="fas fa-search">szukaj</label>
            </div>
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    ...
                    <p>
                        ...
                        W sercu miasta, gdzie codzienność miesza się z chwilami wytchnienia, znajduje się Kawiarnia Sombrerro – miejsce, które powstało z miłości do kawy, czekolady i radości płynącej z małych przyjemności życia.  
                        W naszej kawiarni każdy znajdzie coś dla siebie – od aromatycznej kawy przygotowanej z najlepszych ziaren, po ręcznie robione desery, które rozpieszczą Twoje podniebienie. To nie tylko miejsce, gdzie możesz cieszyć się pysznym jedzeniem, ale również przestrzeń, która zaprasza do zatrzymania się na chwilę, odpoczynku i spotkań z bliskimi.  
                        
                        <br><br><i>Co nas wyróżnia?</i> <br> 
                        ☕ <b>Kawa o wyjątkowym smaku</b> – wyselekcjonowane ziarna z najlepszych plantacji, które wydobywają głębię aromatów w każdej filiżance.<br>  
                        🍰 <b>Desery z sercem</b> – od klasycznego tiramisu, przez kremowe serniki, po nietuzinkowe ciasta inspirowane kuchniami świata.  <br>
                        🎨 <b>Unikalny klimat</b> – połączenie nowoczesności z nutą meksykańskiego luzu – sombrero w nazwie to nie przypadek!  <br>

                    </p>
                    <p>
                        
                        Dla każdego coś pysznego  
                        Czy jesteś miłośnikiem porannego espresso, czy relaksujesz się przy popołudniowym cappuccino – Kawiarnia Sombrerro ma dla Ciebie idealną propozycję. Zajrzyj też na naszą sezonową kartę – znajdziesz tam gorące napoje, które ogrzeją zimą i orzeźwiające koktajle na lato.  
                        <br>
                ...
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <div class="content">
                            ...
                            <p>Czy kiedykolwiek zastanawiałeś się, jak różne metody parzenia kawy wpływają na jej smak, aromat i właściwości zdrowotne? Jeśli tak, to ten artykuł jest dla Ciebie.</p>
                            <center>
                                <a href="https://swiezopalona.pl/blog/porownanie-roznych-metod-parzenia-kawy-espresso-i-kawiarka" target="_blank" class="btn">Czytaj więcej</a>
                            </center>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <div class="content">
                            ...
                            <p>Kawa, napój o głębokim smaku, aromacie i pobudzających właściwościach, od wieków towarzyszy ludzkości, a jej spożycie nieustannie wzrasta na całym świecie. Dla wielu osób kawa to codzienny rytuał, a dla innych – ważny element kultury i tradycji.</p>
                            <center>
                                <a href="https://www.explosia.blog/ciekawostki-zwiazane-z-kawa/przyszlosc-kawy-wyzwania-i-innowacje-w-swiecie-kawy/" target="_blank" class="btn">Czytaj więcej</a>
                            </center>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <div class="content">
                            ...
                            <p>Zapraszamy do odkrycia z nami ekspresów, które w 2024 roku definiują standardy jakości, wygody i stylu, by każdy poranek mógł być początkiem czegoś wyjątkowego. Oto nasz wyjątkowy ranking ekspresów do kawy na rok 2024</p>
                            <center>
                                <a href="https://www.konesso.pl/RANKING-NAJLEPSZYCH-AUTOMATYCZNYCH-EKSPRESOW-2024-blog-pol-1711007082.html" target="_blank" class="btn">Czytaj więcej</a>
                            </center>
                        </div>
                    </div>
                </div>
 ...
 <section class="contact" id="contact">
    ...
    <div class="row">
        <div id="map" class="map pull-left">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2563.9114942322176!2d22.45310407701254!3d50.013014071512025!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x473c92277e781eb1%3A0x63e46b804bba156b!2sUrzejowice%20152A%2C%2037-221%20Urzejowice!5e0!3m2!1spl!2spl!4v1732310993264!5m2!1spl!2spl" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
...
<section class="footer">
    <div class="footer-container">
        ...
        <div class="credit">
            ...
            <h2>Stworzone przez <span>Dawid Stachiewicz</span> || <span>Jakub Soboń</span> || <span>Katarzyna Strzępek</span></h2>
        </div>
    </div>
</section>
